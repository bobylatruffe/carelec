  ...
  render() {
    return (
      <div id="ccm-contents">
        ...
        <div className="ccm-content-n">
          <h3>Commencer par <span className="red">estimer</span> le coût de l'entretien de votre véhicule.</h3>
        ...
        <div className="ccm-content-n">
          <h3>Choisissez la date et un créneau pour qu'on puisse venir <span class="red">récupérer</span> votre véhicule.</h3>
